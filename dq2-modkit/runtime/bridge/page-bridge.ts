// @ts-nocheck
/* eslint-disable */
// This browser-injected bridge relies on runtime globals from the NW.js game context.
// We keep the source in TypeScript but avoid typing every external game API.
