...
$TemplateRoot = Join-Path $SkillRoot "assets\dq2-modkit_template"
...
$Destination = Join-Path $ResolvedGameRoot "dq2-modkit"
...
Write-Host "dq2-modkit scaffolded at $Destination"
