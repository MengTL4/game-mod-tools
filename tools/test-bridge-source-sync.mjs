...
const runtimeSource = path.join(projectRoot, "runtime", "bridge", "src", "page-bridge.js");
const runtimeOutput = path.join(projectRoot, "runtime", "bridge", "page-bridge.js");
const templateSource = path.join(templateRoot, "runtime", "bridge", "src", "page-bridge.js");
const templateOutput = path.join(templateRoot, "runtime", "bridge", "page-bridge.js");
const buildScript = path.join(projectRoot, "tools", "build-bridge.mjs");
