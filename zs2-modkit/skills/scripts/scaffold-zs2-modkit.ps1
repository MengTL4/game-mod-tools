...
$TemplateRoot = Join-Path $SkillRoot "assets\zs2-modkit_template"
...
$Destination = Join-Path $ResolvedGameRoot "zs2-modkit"
...
Write-Host "zs2-modkit scaffolded at $Destination"
