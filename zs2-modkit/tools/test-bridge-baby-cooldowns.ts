...
const firstSkill = baby._realSkills[1] as unknown as { id: number; afterBattleCooldown: number };
assert.equal(firstSkill.id, 2667);
assert.equal(firstSkill.afterBattleCooldown, 0);
