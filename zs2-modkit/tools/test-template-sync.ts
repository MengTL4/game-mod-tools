...
const pairs = [
  ...
  ["runtime bridge source", "runtime/bridge/src/page-bridge.ts"],
  ...
  ["bridge build script", "tools/build-bridge.ts"],
  ["gui html build script", "tools/build-gui-html.ts"],
  ["bridge source sync test", "tools/test-bridge-source-sync.ts"],
  ["bridge source parts test", "tools/test-bridge-source-parts.ts"],
  ["bridge version sync test", "tools/test-bridge-version-sync.ts"],
  ["bridge baby cooldowns test", "tools/test-bridge-baby-cooldowns.ts"],
  ["bridge command router test", "tools/test-bridge-command-router.ts"],
  ["bridge save paths test", "tools/test-bridge-save-paths.ts"],
  ["launch scripts bridge build test", "tools/test-launch-scripts-build-bridge.ts"],
  ["gui bindings module test", "tools/test-gui-bindings-module.ts"],
  ["gui css split test", "tools/test-gui-css-split.ts"],
  ["gui html split test", "tools/test-gui-html-split.ts"],
  ["gui status copy test", "tools/test-gui-status-copy.ts"],
  ["gui ui refresh test", "tools/test-gui-ui-refresh.ts"],
  ["gui offline hunt view test", "tools/test-gui-offline-hunt-view-module.ts"],
  ["gui phase2 modules test", "tools/test-gui-phase2-modules.ts"]
];
