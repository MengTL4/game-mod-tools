...
const parts = [
  "runtime/bridge/src/parts/00-bootstrap.js",
  "runtime/bridge/src/parts/10-runtime-data.js",
  "runtime/bridge/src/parts/20-baby-core.js",
  "runtime/bridge/src/parts/21-baby-skills.js",
  "runtime/bridge/src/parts/22-battle-map-actors.js",
  "runtime/bridge/src/parts/30-hooks.js",
  "runtime/bridge/src/parts/40-hangup-offline-drops.js",
  "runtime/bridge/src/parts/41-offline-run-state.js",
  "runtime/bridge/src/parts/42-progress-unlocks.js",
  "runtime/bridge/src/parts/43-command-ids.js",
  "runtime/bridge/src/parts/50-runtime-inspect.js",
  "runtime/bridge/src/parts/60-command-router.js",
  "runtime/bridge/src/parts/90-startup.js"
];
...
const buildScript = readFileSync(path.join(projectRoot, "tools", "build-bridge.mjs"), "utf8");
for (const relativePath of parts) {
