...
$TemplateRoot = Join-Path $SkillRoot "assets\zs2_modkit_template"
...
$Destination = Join-Path $ResolvedGameRoot "zs2_modkit"
...
Write-Host "zs2_modkit scaffolded at $Destination"
