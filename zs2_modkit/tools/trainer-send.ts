...
function usage() {
  ...
  npx tsx trainer-send.ts gold.add 10000
  npx tsx trainer-send.ts gold.set 999999
  npx tsx trainer-send.ts variable.set 12 999
  npx tsx trainer-send.ts switch.set 34 true
  npx tsx trainer-send.ts item.add item 5 10
  npx tsx trainer-send.ts actor.unlock 1
  npx tsx trainer-send.ts actor.add 1
  npx tsx trainer-send.ts actor.remove 1
  npx tsx trainer-send.ts actor.recover 1
  npx tsx trainer-send.ts actor.level.set 1 20
  npx tsx trainer-send.ts actor.exp.add 1 1000
  npx tsx trainer-send.ts actor.skill.learn 1 10
  npx tsx trainer-send.ts actor.skill.forget 1 10
  npx tsx trainer-send.ts actor.param.add 1 2 50
  npx tsx trainer-send.ts progress.enemyBook.unlock
  npx tsx trainer-send.ts party.recover
  npx tsx trainer-send.ts trainer.options.set expRate=2 goldRate=2 dropRate=3 noSkillCost=true oneHitKill=true invincible=true
  npx tsx trainer-send.ts trainer.hooks.info
  npx tsx trainer-send.ts battle.start 192
  npx tsx trainer-send.ts battle.start variableId=399
  npx tsx trainer-send.ts battle.killEnemies
  npx tsx trainer-send.ts battle.escape
  npx tsx trainer-send.ts hangup.info
  npx tsx trainer-send.ts hangup.start
  npx tsx trainer-send.ts hangup.stop
  npx tsx trainer-send.ts hangup.refresh
  npx tsx trainer-send.ts offlineHunt.info
  npx tsx trainer-send.ts offlineHunt.preview 31
  npx tsx trainer-send.ts offlineHunt.preview troopId=192
  npx tsx trainer-send.ts offlineHunt.run mapId=31 times=10 enemyBook=true recover=true save=false autoSellQualities=0,1,2 blockDropQualities=1,2,3
  npx tsx trainer-send.ts offlineHunt.run troopId=192 times=10 enemyBook=true save=false autoSellQualities=0,1,2,3,4
  npx tsx trainer-send.ts runtime.search talent title clothe stsSp
  npx tsx trainer-send.ts runtime.inspect window.TK.$ 300
  npx tsx trainer-send.ts talent.points.info party
  npx tsx trainer-send.ts talent.points.set 1 20
  npx tsx trainer-send.ts talent.points.add 1 5
  npx tsx trainer-send.ts talent.points.add party 10
  npx tsx trainer-send.ts talent.points.add 1 5 csp 3
  npx tsx trainer-send.ts title.info
  npx tsx trainer-send.ts title.unlock 1
  npx tsx trainer-send.ts title.unlockAll
  npx tsx trainer-send.ts costume.info
  npx tsx trainer-send.ts costume.unlock 1001
  npx tsx trainer-send.ts costume.unlockAll
  npx tsx trainer-send.ts baby.info
  npx tsx trainer-send.ts baby.skill.learn 1001 1890 passive
  npx tsx trainer-send.ts baby.skill.learn 1001 3555 action slot=2
  npx tsx trainer-send.ts baby.skill.forget 1001 1890 passive
  npx tsx trainer-send.ts baby.skill.clear 1001 passive
  npx tsx trainer-send.ts baby.slots.set 1001 5
  npx tsx trainer-send.ts baby.slots.add 1001 1
  npx tsx trainer-send.ts map.current
  npx tsx trainer-send.ts map.transfer 5 10 12
  npx tsx trainer-send.ts map.through.set true
  npx tsx trainer-send.ts map.through.toggle
  npx tsx trainer-send.ts commonEvent.run 10
  npx tsx trainer-send.ts save 1
  npx tsx trainer-send.ts title.refresh`);
}
...
function parseKeyValueArgs(parts: string[]): Record<string, any> {
...
function makeOfflineHuntCommand(type: string, args: string[]): Record<string, any> {
...
function makeCommand(argv: string[]): Record<string, any> | null {
  const type = argv[0];
